...
1. gli sviluppatori ad utilizzare un linguaggio di programmazione compatibile con Linux, come ad esempio Java o Python. Sarà inoltre necessario utilizzare un server MySQL per gestire il database del sito.
## casi d'uso
### utente registrato
